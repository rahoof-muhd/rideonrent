    ...
    <div class="main-container">
        <div class="left-container">
            <div class="left-div">
                ...
                <form action="Login/process" method="post" style="margin-top:7vh">
                    ...
                    <div class="register">
                        <p style="color:white; margin-top:10px">Don't have an account? <a href="register" style="font-weight:900">Sign Up</a></p>
                    </div>
                </form>
            </div>
        </div>
